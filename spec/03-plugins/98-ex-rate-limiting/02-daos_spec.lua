...
describe("Plugin: ex-rate-limiting (DAO)", function()
  local api_id = uuid()
  ...
  it("should return nil when ex-rate-limiting metrics are not existing", function()
  ...
  it("should increment ex-rate-limiting metrics with the given period", function()
    local current_timestamp = 1424217600
    local periods = timestamp.get_timestamps(current_timestamp)
